...
async function guardarEnGoogleSheets(oferta, client, spreadsheetId) {
...
async function ofertasComputrabajo() {
  ...
  // AUTENTICACIÓN GOOGLE SHEETS (dentro de la función para usar await)
  ...
  for (const link of links) {
    ...
    try {
      ...
      await guardarEnGoogleSheets(oferta, client, spreadsheetId);
    } catch (error) {
